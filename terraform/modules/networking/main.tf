...
# Creates isolated network for OpenClaw agents
...
# Public Subnets (for NAT Gateway, Bastion, ALB)
...
# Note: This costs ~$32/month per AZ. For dev, you might only want 1.
...
# VPC Endpoints for AWS Services (saves data transfer costs)
